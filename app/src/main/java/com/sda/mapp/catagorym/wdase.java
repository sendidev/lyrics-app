package com.sda.mapp.catagorym;
...
import com.sda.mapp.MezmursAdapter;
import com.sda.mapp.R;
import com.sda.mapp.Selectonitemklik;
import com.sda.mapp.mezmurs;
import com.sda.mapp.nbnav.searchFragment;
import com.sda.mapp.randommezmurcolation.mezmursActivity;
...
public class wdase extends AppCompatActivity implements Selectonitemklik {
 ...
 private TextView tv;
    ...
    MezmursAdapter re;
 private List<com.sda.mapp.mezmurs> mezmurs=new ArrayList<>();
    @Override
...
if(name.equals("የቀበና ቤ/ክ መዘምራን")){
   ...
   Toast.makeText(this, name, Toast.LENGTH_SHORT).show();
    ...
    selamu();
    Toast.makeText(this, name, Toast.LENGTH_SHORT).show();
}else if (name.equals("ዘማሪ ጴጥሮስ ሐንዲሶ")){
    tv.setText(name);
    petros();
    Toast.makeText(this, name, Toast.LENGTH_SHORT).show();
...
}else if (name.equals("ዘማሪት ኃይማኖት ታደሰ")){
    tv.setText(name);
    hyma();
    Toast.makeText(this, name, Toast.LENGTH_SHORT).show();
    ...
    private void taborhawassa(){
        mezmurs.add(new mezmurs("4","ለእግዚአብሔር ሁሉ ይቻላል", "የሐዋሳ ታቦር ቤ/ክ የኤልሻዳይ መዘምራን",R.string.ለእግዚአብሔርሁሉይቻላል,"0"));
        ...
        mezmurs.add(new mezmurs("10","ልትወደስ", "የሐዋሳ ታቦር ቤ/ክ የኤልሻዳይ መዘምራን",R.string.ልትወደስ,"0"));
        mezmurs.add(new mezmurs("12","ማንም የለም ጥበበኛ","የሐዋሳ ታቦር ቤ/ክ የኤ መዘምራን", R.string.ማንምየለምጥበበኛ,"0"));



        mezmurs.add(new mezmurs("20","በታላቅ ጉባዔ","የሐዋሳ ታቦር ቤ/ክ የኤልሻዳይ መዘምራን", R.string.በታላቅጉባዔ,"0"));
        mezmurs.add(new mezmurs("21","በችግር በጭንቅ ሰዓት","የሐዋሳ ታቦር ቤ/ክ ውዳሴ መዘምራን", R.string.በችግርበጭንቅሰዓት,"0"));
        mezmurs.add(new mezmurs("24","በገና መሰንቆ ይዘን","የሐዋሳ ታቦር ቤ/ክ የኤልሻዳይ መዘምራን", R.string.በገናመሰንቆይዘን,"0"));

        mezmurs.add(new mezmurs("25","ብዙ ምስጋና አለኝ", "የሐዋሳ ታቦር ቤ/ክ ውዳሴ መዘምራን",R.string.ብዙምስጋናአለኝ,"0"));

        mezmurs.add(new mezmurs("26","ችግሬን በሱ ላይ ጥዬበት","የሐዋሳ ታቦር ቤ/ክ ውዳሴ መዘምራን", R.string.ችግሬንበሱላይጥዬበት,"0"));

        mezmurs.add(new mezmurs("28","አልችልም ባልኩት ላይ", "የሐዋሳ ታቦር ቤ/ክ የኤልሻዳይ መዘምራን",R.string.አልችልምባልኩትላይ,"0"));
        ...
        mezmurs.add(new mezmurs("39","አየሁ ማዳንህን","የሐዋሳ ታቦር ቤ/ክ የኤልሻዳይ መዘምራን", R.string.አየሁማዳንህን,"0"));

        mezmurs.add(new mezmurs("41","አዲስ ዝማሬ","የሐዋሳ ታቦር ቤ/ክ የኤልሻዳይ መዘምራን", R.string.አዲስዝማሬ,"0"));

        mezmurs.add(new mezmurs("42","አፋችንን ሞላው","የሐዋሳ ታቦር ቤ/ክ የኤ መዘምራን", R.string.አፋችንንሞላው,"0"));

        mezmurs.add(new mezmurs("43","ኢየሱስ ባንተ ነው", "የሐዋሳ ታቦር ቤ/ክ የኤልሻዳይ መዘምራን",R.string.ኢየሱስባንተነው,"0"));

        mezmurs.add(new mezmurs("44","እስቲ ድምፄን ላሰማ","የሐዋሳ ታቦር ቤ/ክ ውዳሴ መዘምራን", R.string.እስቲድምፄንላሰማ,"0"));

        mezmurs.add(new mezmurs("45","እገረማለሁ","የሐዋሳ ታቦር ቤ/ክ የኤልሻዳይ መዘምራን", R.string.እገረማለሁ,"0"));
        ...
        mezmurs.add(new mezmurs("49","እግዚአብሔር መልካም","የሐዋሳ ታቦር ቤ/ክ የኤልሻዳይ መዘምራን", R.string.እግዚአብሔርመልካም,"0"));

        mezmurs.add(new mezmurs("50","እግዚአብሔር በጭንቅ ቀን ", "የሐዋሳ ታቦር ቤ/ክ የኤልሻዳይ መዘምራን",R.string.እግዚአብሔርበጭንቅቀን,"0"));
        ...
        mezmurs.add(new mezmurs("62","የጌታ ውለታ", "የሐዋሳ ታቦር ቤ/ክ የኤልሻዳይ መዘምራን",R.string.የጌታውለታ,"0"));

        mezmurs.add(new mezmurs("65","ይህ ሁሉ ለእኔ ነው ", "የሐዋሳ ታቦር ቤ/ክ ውዳሴ መዘምራን",R.string.ይህሁሉለእኔነው,"0"));
        mezmurs.add(new mezmurs("67","ጌታ አይጥልህም","የሐዋሳ ታቦር ቤ/ክ የኤልሻዳይ መዘምራን", R.string.ጌታአይጥልህም,"0"));
    ...
    private void negatu(){
        ...
        mezmurs.add(new mezmurs("30","አምላኬ ከጐኔ ቁምልኝ", "ዘማሪ ገነቱ ጋጋዶ",R.string.አምላኬከጐኔቁምልኝ,"0"));
        mezmurs.add(new mezmurs("76","በምስጋና", "ዘማሪ ገነቱ ጋጋዶ",R.string.በምስጋና,"0"));
        mezmurs.add(new mezmurs("82", "ድንቁን አወራለሁ", "ዘማሪ ገነቱ ጋጋዶ",R.string.ድንቁንአወራለሁ,"0"));
    ...
    private void anbela(){
        ...
        mezmurs.add(new mezmurs("81","እኔን ላከኝ", "የአበላ ቤ/ክ መዘምራን",R.string.እኔንላከኝ,"0"));
    ...
    private void hyma(){
        ...
        mezmurs.add(new mezmurs("83", "ባይመጥንህም", "ዘማሪት ኃይማኖት ታደሰ",R.string.ባይመጥንህም,"0"));
    ...
    @Override
    public void onItemcliklistener(com.sda.mapp.mezmurs mzmur, CardView con1, ConstraintLayout c2, TextView id, TextView title, ImageView like, int position) {
